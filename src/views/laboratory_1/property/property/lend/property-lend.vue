<template>
  <div class="app-container">
    ...
    <div class="detail-button">
      <el-button type="primary" @click="handleNormalLend" size="medium">普通出借</el-button>
      <el-button type="primary" @click="handleBatchLend" size="medium">批量出借</el-button>
    </div>
    ...
    <el-collapse-transition>
      <div v-show="showBatchBtn">
        ...
        <el-table :data="batchLendData" border highlight-current-row style="width: 100%;margin-top:20px;">
...
<script>
  ...
  export default {
    ...
    methods: {
      /* 获取列表信息 */
      getTableList() {
        this.normalLendData = fakeDataList
