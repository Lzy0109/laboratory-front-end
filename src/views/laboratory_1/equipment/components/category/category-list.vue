...
<script>
  ...
  import { fetchComponentsCategoryInfos } from '@/api/laboratory_1/equ-components-category'
  export default {
    name: 'category-list',
    components: {
      Pagination
    ...
    methods: {
      /** 获取列表信息 **/
      getTableList() {
        fetchComponentsCategoryInfos(this.queryList).then(res => {
