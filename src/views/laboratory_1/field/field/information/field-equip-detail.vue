        ...
        <el-row type="flex" class="row-bg" justify="space-around">
          ...
          <el-col :span="8">
            <el-form-item label="出产日期" label-width="100px" prop="info">
              <el-input v-show="isRead" v-model="dataForm.equ_produceDate" style="width: auto" :readonly="isRead" />
              <el-date-picker v-show="!isRead" v-model="dataForm.equ_produceDate" type="date" value-format="yyyy-MM-dd" clearable />
            </el-form-item>
          </el-col>
          <el-col :span="8">
        ...
        <el-row type="flex" class="row-bg" justify="space-around">
          <el-col :span="8">
            <el-form-item label="购置日期" label-width="100px" prop="info">
              <el-input v-show="isRead" v-model="dataForm.equ_purchaseDate" style="width: auto" :readonly="isRead" />
              <el-date-picker v-show="!isRead" v-model="dataForm.equ_purchaseDate" type="date" value-format="yyyy-MM-dd" clearable />
            </el-form-item>
          </el-col>
          <el-col :span="8">
